...
export const LEAPMONTH_NUM_BIT = 13;

export const STAR_ZODIAC_NAME = ['摩羯座', '水瓶座', '双鱼座', '白羊座', '金牛座', '双子座', '巨蟹座', '狮子座', '处女座', '天秤座', '天蝎座', '射手座'];
export const STAR_ZODIAC_DATE = [[1, 20], [2, 19], [3, 21], [4, 21], [5, 21], [6, 22], [7, 23], [8, 23], [9, 23], [10, 23], [11, 23], [12, 23]];
...
export const EAST_ZODIAC_LIST = ['玄枵', '娵訾', '降娄', '大梁', '实沈', '鹑首', '鹑火', '鹑尾', '寿星', '大火', '析木', '星纪'];

export const the10HeavenlyStems = ['甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸'];
export const the10HeavenlyStems5ElementsList = ['木', '木', '火', '火', '土', '土', '金', '金', '水', '水'];
export const the12EarthlyBranches = ['子', '丑', '寅', '卯', '辰', '巳', '午', '未', '申', '酉', '戌', '亥'];
export const the12EarthlyBranches5ElementsList = ['水', '土', '木', '木', '土', '火', '火', '土', '金', '金', '土', '水'];

export const the60HeavenlyEarth = Array.from({ length: 60 }, (_, i) => {
    return the10HeavenlyStems[i % 10] + the12EarthlyBranches[i % 12];
});
...
export const chineseZodiacNameList = ['鼠', '牛', '虎', '兔', '龙', '蛇', '马', '羊', '猴', '鸡', '狗', '猪'];
export const chinese12DayOfficers = '建除满平定执破危成收开闭';
export const chinese12DayGods = ['青龙', '明堂', '天刑', '朱雀', '金贵', '天德', '白虎', '玉堂', '天牢', '玄武', '司命', '勾陈'];

export const directionList = ['正北', '东北', '正东', '东南', '正南', '西南', '正西', '西北'];
export const chinese8Trigrams = '坎艮震巽离坤兑乾';

export const luckyGodDirection = '艮乾坤离巽艮乾坤离巽';
export const wealthGodDirection = '艮艮坤坤坎坎震震离离';
export const mascotGodDirection = '坎坤乾巽艮坎坤乾巽艮';
export const sunNobleDirection = '坤坤兑乾艮坎离艮震巽';
export const moonNobleDirection = '艮坎乾兑坤坤艮离巽震';
...
export const meridiansName = ['胆', '肝', '肺', '大肠', '胃', '脾', '心', '小肠', '膀胱', '肾', '心包', '三焦'];

export const lunarMonthNameList = ['正月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '冬月', '腊月'];
export const lunarDayNameList = [
    '初一', '初二', '初三', '初四', '初五', '初六', '初七', '初八', '初九', '初十',
    '十一', '十二', '十三', '十四', '十五', '十六', '十七', '十八', '十九', '二十',
    '廿一', '廿二', '廿三', '廿四', '廿五', '廿六', '廿七', '廿八', '廿九', '三十'
];
export const upperNum = ['零', '一', '二', '三', '四', '五', '六', '七', '八', '九'];
export const weekDay = ['星期一', '星期二', '星期三', '星期四', '星期五', '星期六', '星期日'];

export const ENC_VECTOR_LIST = [4, 19, 3, 18, 4, 19, 4, 19, 4, 20, 4, 20, 6, 22, 6, 22, 6, 22, 7, 22, 6, 21, 6, 21];

// 修正：移除 BigInt 后缀 n，使用字符串表示大整数，在解析时转换
...
export const lunarMonthData = [
    0x00752, 0x00ea5, 0x0ab2a, 0x0064b, 0x00a9b, 0x09aa6, 0x0056a, 0x00b59, 0x04baa, 0x00752,
    0x0cda5, 0x00b25, 0x00a4b, 0x0ba4b, 0x002ad, 0x0056b, 0x045b5, 0x00da9, 0x0fe92, 0x00e92,
    0x00d25, 0x0ad2d, 0x00a56, 0x002b6, 0x09ad5, 0x006d4, 0x00ea9, 0x04f4a, 0x00e92, 0x0c6a6,
    0x0052b, 0x00a57, 0x0b956, 0x00b5a, 0x006d4, 0x07761, 0x00749, 0x0fb13, 0x00a93, 0x0052b,
    0x0d51b, 0x00aad, 0x0056a, 0x09da5, 0x00ba4, 0x00b49, 0x04d4b, 0x00a95, 0x0eaad, 0x00536,
    0x00aad, 0x0baca, 0x005b2, 0x00da5, 0x07ea2, 0x00d4a, 0x10595, 0x00a97, 0x00556, 0x0c575,
    0x00ad5, 0x006d2, 0x08755, 0x00ea5, 0x0064a, 0x0664f, 0x00a9b, 0x0eada, 0x0056a, 0x00b69,
    0x0abb2, 0x00b52, 0x00b25, 0x08b2b, 0x00a4b, 0x10aab, 0x002ad, 0x0056d, 0x0d5a9, 0x00da9,
    0x00d92, 0x08e95, 0x00d25, 0x14e4d, 0x00a56, 0x002b6, 0x0c2f5, 0x006d5, 0x00ea9, 0x0af52,
    0x00e92, 0x00d26, 0x0652e, 0x00a57, 0x10ad6, 0x0035a, 0x006d5, 0x0ab69, 0x00749, 0x00693,
    0x08a9b, 0x0052b, 0x00a5b, 0x04aae, 0x0056a, 0x0edd5, 0x00ba4, 0x00b49, 0x0ad53, 0x00a95,
    0x0052d, 0x0855d, 0x00ab5, 0x12baa, 0x005d2, 0x00da5, 0x0de8a, 0x00d4a, 0x00c95, 0x08a9e,
    0x00556, 0x00ab5, 0x04ada, 0x006d2, 0x0c765, 0x00725, 0x0064b, 0x0a657, 0x00cab, 0x0055a,
    0x0656e, 0x00b69, 0x16f52, 0x00b52, 0x00b25, 0x0dd0b, 0x00a4b, 0x004ab, 0x0a2bb, 0x005ad,
    0x00b6a, 0x04daa, 0x00d92, 0x0eea5, 0x00d25, 0x00a55, 0x0ba4d, 0x004b6, 0x005b5, 0x076d2,
    0x00ec9, 0x10f92, 0x00e92, 0x00d26, 0x0d516, 0x00a57, 0x00556, 0x09365, 0x00755, 0x00749,
    0x0674b, 0x00693, 0x0eaab, 0x0052b, 0x00a5b, 0x0aaba, 0x0056a, 0x00b65, 0x08baa, 0x00b4a,
    0x10d95, 0x00a95, 0x0052d, 0x0c56d, 0x00ab5, 0x005aa, 0x085d5, 0x00da5, 0x00d4a, 0x06e4d,
    0x00c96, 0x0ecce, 0x00556, 0x00ab5, 0x0bad2, 0x006d2, 0x00ea5, 0x0872a, 0x0068b, 0x10697,
    0x004ab, 0x0055b, 0x0d556, 0x00b6a, 0x00752, 0x08b95, 0x00b45, 0x00a8b, 0x04a4f
];

export const lunarNewYearList = [
    
];
...
export const thingsSort = ['祭祀', '出行', '移徙', '结婚姻', '宴会', '嫁娶', '安床', '沐浴', '剃头', '修造', '求医疗病', '上表章', '上官', '入学', '冠带', '进人口',
